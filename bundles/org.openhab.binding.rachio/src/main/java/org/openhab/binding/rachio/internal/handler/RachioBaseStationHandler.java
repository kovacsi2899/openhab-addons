...
public class RachioBaseStationHandler extends AbstractRachioThingHandler {
    ...
    protected void postChannelData() {
        ...
        updateChannel(CHANNEL_BASESTATION_NAME, new StringType(currentBaseStation.getThingName()));
        updateChannel(CHANNEL_BASESTATION_ONLINE, onlineState(currentBaseStation));
